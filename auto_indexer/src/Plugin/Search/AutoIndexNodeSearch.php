...
class AutoIndexNodeSearch extends NodeSearch {
  ...
  public function indexSingleNode(NodeInterface $node) {
    ...
    // Register a shutdown function to ensure the totals get recalculated.
    drupal_register_shutdown_function('auto_index_search_update_totals', $words);
  }
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['autoindex']['automatic_indexing'] = [
      '#type' => 'checkbox',
